package com.lidroid.xutils.core;
...
public abstract class AsyncTask<Params, Progress, Result> {
	...
	private static final ThreadFactory sThreadFactory = new ThreadFactory() {
		...
		public Thread newThread(Runnable r) {
			...
			tread.setPriority(Thread.NORM_PRIORITY - 1);// do modify
			return tread;
		}
	};
	...
	public static final Executor THREAD_POOL_EXECUTOR = new ThreadPoolExecutor(CORE_POOL_SIZE, MAXIMUM_POOL_SIZE, KEEP_ALIVE,
			TimeUnit.SECONDS, sPoolWorkQueue, sThreadFactory, new ThreadPoolExecutor.DiscardOldestPolicy());// 添加线程无法处理时采用DiscardOldestPolicy策略
	...
	public static final Executor DUAL_THREAD_EXECUTOR = Executors.newFixedThreadPool(3, sThreadFactory);// 新添加一个固定线程池
