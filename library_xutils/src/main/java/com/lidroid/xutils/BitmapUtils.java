...
import com.lidroid.xutils.bitmap.core.BitmapProcess;
import com.lidroid.xutils.bitmap.display.Displayer;
import com.lidroid.xutils.bitmap.display.SimpleDisplayer;
import com.lidroid.xutils.bitmap.download.Downloader;
import com.lidroid.xutils.bitmap.download.SimpleDownloader;
import com.lidroid.xutils.util.Utils;
import com.lidroid.xutils.core.AsyncTask;
...
public class BitmapUtils {
	...
	private static BitmapUtils mFinalBitmap;
	 ...
	 * @return
	 */
	public static synchronized BitmapUtils create(Context ctx) {
		if (mFinalBitmap == null) {
			mFinalBitmap = new BitmapUtils(ctx.getApplicationContext());
		}
		return mFinalBitmap;
	}
	 ...
	 * @param bitmap
	 */
	public BitmapUtils configLoadfailImage(Bitmap bitmap) {
	 ...
	 * @param resId
	 */
	public BitmapUtils configLoadfailImage(int resId) {
	 ...
	 * @return
	 */
	public BitmapUtils configDownlader(Downloader downlader) {
	 ...
	 * @return
	 */
	public BitmapUtils configDisplayer(Displayer displayer) {
	 ...
	 * @return
	 */
	public BitmapUtils configDiskCachePath(String strPath) {
	 ...
	 *            缓存大小
	 */
	public BitmapUtils configMemoryCacheSize(int size) {
	 ...
	 */
	public BitmapUtils configMemoryCachePercent(float percent) {
	 ...
	 * @param size
	 */
	public BitmapUtils configDiskCacheSize(int size) {
	 ...
	 * @param size
	 */
	public BitmapUtils configBitmapLoadThreadSize(int size) {
		if (size >= 1)
	 ...
	 * @return
	 */
	public BitmapUtils configRecycleImmediately(boolean recycleImmediately) {
