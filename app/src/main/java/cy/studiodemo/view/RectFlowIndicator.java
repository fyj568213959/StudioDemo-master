 ...
 * </ul>
 */
public class RectFlowIndicator extends View implements FlowIndicator, AnimationListener {
     ...
     * @param context
     */
    public RectFlowIndicator(Context context) {// live_play_list_bg_p
        super(context);
        this.mContext = context;
        int activeC = mContext.getResources().getColor(R.color.white);
        int inactiveC = mContext.getResources().getColor(R.color.grey);
        initColors(activeC, inactiveC, STYLE_FILL, STYLE_FILL);
    }
    ...
    public void setProperty(float radius, float circleSeparation, float activeRadius, int fadeOutTime, boolean mCentered) {
        this.radius = radius;
        this.circleSeparation = circleSeparation;
    ...
    public void setInactivePaintStyle() {
        mPaintInactive.setStyle(Style.STROKE);
        mPaintInactive.setAntiAlias(true);
        mPaintInactive.setStrokeWidth((float) 3.0);
        mPaintInactive.setColor(Color.RED);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int iLoop = 0; iLoop < count; iLoop++) {
            ...
            // canvas.drawRect(leftPadding + (iLoop * circleSeparation) +
            // centeringOffset, getPaddingTop(), leftPadding
            // + radius + (iLoop * circleSeparation) + centeringOffset + radius,
        ...
        // canvas.drawRect(leftPadding + cx + centeringOffset - radius / 2,
        // getPaddingTop() - radius / 2, leftPadding
        // + radius + cx + centeringOffset + radius + radius / 2,
        // getPaddingTop() + radius + radius + radius / 2,
        // mPaintActive);
    }
